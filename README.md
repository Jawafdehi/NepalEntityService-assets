...
Nepal Entity Service assets repository with Jekyll website for GitHub Pages.

## About the Meta Repository

**For Jawafdehi team members and interns**: This service is part of the [Jawafdehi meta-repository](https://github.com/Jawafdehi/jawafdehi-meta), which provides documentation, specs, and shared resources. Working from the meta repo setup is encouraged for full project context.
